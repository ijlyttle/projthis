...
You could imagine building package functions
...
- hit the "Build" button before rendering a workflow, to install your package
- hit the "Check" button early and often

Supported by the GitHub Action

At some point, there might be a parting-of-the-ways between the workflow and its attached package.

### github_document: the little format that could

## Summary

Lots of comprehensive tools out there to support:
