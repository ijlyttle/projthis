...
2.  In this context, a "workflow" is a sequence of RMarkdown files.
...
-   `proj_install_deps()`: Installs the package-dependncies listed in the DESCRIPTION file.
...
This approach is suggested by Sharla Gelfand, first in a [blog post](https://sharla.party/post/usethis-for-reporting/), then in an [rstudio::conf() presentation](https://rstudio.com/resources/rstudioconf-2020/don-t-repeat-yourself-talk-to-yourself-repeated-reporting-in-the-r-universe/).
