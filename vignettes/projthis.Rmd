...
More details are offered in the [article on managing workflows](workflow-management.html).
...
Let's say we wanted to write a CSV file to the our target directory; within the RMarkdown file you could use:
...
For more information, please read the [article on managing directories](directory-management.html).
...
For more information, please read the [article on workflow automation](workflow-automation.html).
